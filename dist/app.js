  ...
  navLinks.forEach(function (l) {
    l.addEventListener('click', function (ev) {
      ...
      gsap__WEBPACK_IMPORTED_MODULE_1__.default.timeline({
        ...
        attr: {
          'stroke-dashoffset': function strokeDashoffset(idx, target) {
...
/* harmony export */   "getSortedRelativeDistances": () => (/* binding */ getSortedRelativeDistances),
/* harmony export */   "getCoordinatesAroundCircle": () => (/* binding */ getCoordinatesAroundCircle),
/* harmony export */   "createLinesBetweenCircles": () => (/* binding */ createLinesBetweenCircles),
...
var getSortedRelativeDistances = function getSortedRelativeDistances(point, points) {
  var distances = [];
  points.forEach(function (coordinates, idx) {
    var d = Math.pow(coordinates.x - point.x, 2) + Math.pow(coordinates.y - point.y, 2);
    d !== 0 && distances.push({
...
var getCoordinatesAroundCircle = function getCoordinatesAroundCircle(count, radius, baseRadius) {
...
var createLinesBetweenCircles = function createLinesBetweenCircles(circles) {
  var tempCircles = _toConsumableArray(circles);

  var lines = [];

  while (tempCircles.length > 0) {
    shuffle(tempCircles);
    var lineCoordinates = tempCircles.splice(0, 2);
    var line = document.createElementNS('http://www.w3.org/2000/svg', 'line');
    var randomFallbackCoordinates = circles[circles.length * Math.random() | 0];
...
var createSVGElements = function createSVGElements(svgContainer) {
  ...
  circles.forEach(function (n, idx) {
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkschwab_prototypes"] = self["webpackChunkschwab_prototypes"] || [];
